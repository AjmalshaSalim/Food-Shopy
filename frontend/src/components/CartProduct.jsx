...
<img src={image} alt="" className="h-28 w-40 object-cover" />
      ...
      <div className="flex flex-col gap-1 w-full">
          ...
          <div className="flex gap-3 items-center">
            <button className="bg-slate-300 hover:bg-slate-400 rounded py-1 mt-2 p-1  "><IoAdd /></button>
            <p className="font-semibold p-1">{qty}</p>
            <button className="bg-slate-300 hover:bg-slate-400 rounded py-1 mt-2 p-1" onClick={""}><FiMinus /></button>
          </div>
