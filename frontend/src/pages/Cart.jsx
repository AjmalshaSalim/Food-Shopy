        ...
        {productCartItem[0] ? (
          <div className="my-4 flex gap-3">
            ...
            <div className="w-full max-w-md ml-auto">
              ...
              <button
                className="bg-yellow-500 hover:bg-yellow-400 w-full rounded-md text-lg font-semibold py-2 text-white"
          ...
          <>
            <div className="flex w-full justify-center items-center flex-col">
              ...
              />
              <p className="text-slate-500 text-3xl font-semibold pt-5">
                Empty Cart
              </p>
            </div>
          </>
